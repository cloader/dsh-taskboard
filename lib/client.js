	...
	factory: (require) => {
		...
		*/
		function SlashPromptInput({ value, onChange, controller, placeholder, rows = 4, maxLength = 8e3, disabled = false, autoFocus = false, className, ariaLabel }) {
			...
			const insertImageMarkdown = (dataUrl, name = "图片") => {
				const el = textareaRef.current;
				const md = `\n![${name}-${Date.now().toString(36)}](${dataUrl})\n`;
				if (el !== null) {
			...
			const processImageFiles = (files) => {
				for (let i = 0; i < files.length; i++) {
					...
					if (file && file.type.startsWith("image/")) {
						...
						reader.onload = () => {
							if (typeof reader.result === "string") insertImageMarkdown(reader.result, file.name.replace(/\.[^/.]+$/, "") || "图片");
						};
			...
			const handleKeyDown = (e) => {
				if (popupOpen && filteredItems.length > 0) {
					...
					if (e.key === "Enter" || e.key === "Tab") {
						...
						if (target !== void 0) applyCompletion(target);
						return;
					}
					if (e.key === "Escape") {
						e.preventDefault();
			...
			const removeImage = (img) => {
				onChange(value.replace(img.fullMatch, "").trim());
			};
			const extractedImages = (0, react.useMemo)(() => extractMarkdownImages(value), [value]);
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					extractedImages.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: extractedImages.map((img) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
