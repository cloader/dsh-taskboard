	...
	factory: (require) => {
		...
		const DEFAULT_COMMANDS = [
			{
				name: "goal",
				kind: "command",
				description: "自主完成长期目标任务，持续深度推进",
				hint: "<目标描述>"
			},
			{
				name: "schedule",
				kind: "command",
				description: "设置一次性定时或周期性 Cron 调度",
				hint: "<时间/表达式>"
			},
			{
				name: "plan",
				kind: "command",
				description: "在行动前制定分步实施计划并由用户确认"
			},
			{
				name: "browser",
				kind: "command",
				description: "启动网页浏览器交互与实时页面检索"
			},
			{
				name: "grill-me",
				kind: "command",
				description: "通过多轮单题访谈深入对齐需求与设计意图"
			},
			{
				name: "teamwork-preview",
				kind: "command",
				description: "多智能体协作与团队工作流预览"
			},
			{
				name: "learn",
				kind: "command",
				description: "沉淀解决经验与新规则到知识库"
			},
			{
				name: "review",
				kind: "command",
				description: "多维度代码审查（正确性、架构与安全）"
			},
			{
				name: "security",
				kind: "command",
				description: "安全加固与代码漏洞扫描"
			},
			{
				name: "permission",
				kind: "command",
				description: "切换当前会话权限级别 (read-only / workspace-write / full-access)",
				hint: "<preset>"
			}
		];
		...
		const DEFAULT_SKILLS = [
			{
				...
				kind: "skill",
				description: "构建生产级、可访问的高品质前端界面与组件"
			},
			{
				name: "api-and-interface-design",
				kind: "skill",
				description: "设计稳定契约、清晰边界的 REST / RPC 接口"
			},
			{
				name: "test-driven-development",
				kind: "skill",
				description: "测试驱动开发（TDD），编写单元与集成测试"
			},
			{
				name: "debugging-and-error-recovery",
				kind: "skill",
				description: "系统化定位 Bug 根因并恢复错误"
			},
			{
				name: "performance-optimization",
				kind: "skill",
				description: "前后端性能调优、减少渲染开销与查询优化"
			},
			{
				name: "ci-cd-and-automation",
				kind: "skill",
				description: "自动化构建、CI/CD 流水线与质量门禁"
			},
			{
				name: "code-review-and-quality",
				kind: "skill",
				description: "多轴向代码审查与重构指导"
			},
			{
				name: "code-simplification",
				kind: "skill",
				description: "精简复杂逻辑，提升可读性与可维护性"
			},
			{
				name: "context-engineering",
				kind: "skill",
				description: "优化上下文结构与提示词工程"
			},
			{
				name: "doubt-driven-development",
				kind: "skill",
				description: "以怀疑驱动的对抗式审查，确保核心逻辑正确"
			},
			{
				name: "git-workflow-and-versioning",
				kind: "skill",
				description: "Git 工作流、分支管理、语义化版本与变更日志"
			},
			{
				name: "idea-refine",
				kind: "skill",
				description: "通过发散与收敛思维细化方案与假设检验"
			},
			{
				name: "incremental-implementation",
				kind: "skill",
				description: "小步快跑、增量交付多文件变更"
			},
			{
				name: "interview-me",
				kind: "skill",
				description: "深度访谈挖掘真实意图"
			},
			{
				name: "memory-leak-debugging",
				kind: "skill",
				description: "排查诊断 JavaScript/Node.js 内存泄漏"
			},
			{
				name: "observability-and-instrumentation",
				kind: "skill",
				description: "添加日志、指标打点与链路追踪"
			},
			{
				name: "planning-and-task-breakdown",
				kind: "skill",
				description: "将复杂需求拆解为有序可执行任务"
			},
			{
				name: "security-and-hardening",
				kind: "skill",
				description: "防御安全漏洞、输入过滤与鉴权加固"
			},
			{
				name: "shipping-and-launch",
				kind: "skill",
				description: "生产发布前检查清单与回滚策略"
			},
			{
				name: "source-driven-development",
				kind: "skill",
				description: "基于权威官方文档与源码进行设计实现"
			},
			{
				name: "spec-driven-development",
				kind: "skill",
				description: "在编码前制定清晰的技术规范"
			},
			{
				name: "using-agent-skills",
				kind: "skill",
				description: "发现并动态调用智能体各项专业技能"
			}
		];
		...
		*/
		function SlashPromptInput({ value, onChange, controller, placeholder, rows = 4, maxLength = 8e3, disabled = false, autoFocus = false, className, ariaLabel }) {
			...
			const [lightboxUrl, setLightboxUrl] = (0, react.useState)(null);
			const lastPropValueRef = (0, react.useRef)(value);
			const [text, setText] = (0, react.useState)(() => decomposePromptValue(value).text);
			const [images, setImages] = (0, react.useState)(() => decomposePromptValue(value).images);
			(0, react.useEffect)(() => {
			...
			const notifyChange = (nextText, nextImages) => {
				const combined = composePromptValue(nextText, nextImages);
				lastPropValueRef.current = combined;
				onChange(combined);
			};
			const [completions, setCompletions] = (0, react.useState)({
			...
			(0, react.useEffect)(() => {
				...
				controller.fetchPromptCompletions().then((res) => {
					...
					setCompletions((prev) => {
						...
						for (const c of res.commands) cmdMap.set(c.name, {
							...c,
							kind: "command"
						});
						const skillMap = /* @__PURE__ */ new Map();
						for (const s of prev.skills) skillMap.set(s.name, s);
						for (const s of res.skills) skillMap.set(s.name, {
							...s,
							kind: "skill"
						});
						return {
			...
			const addImages = (newImages) => {
				...
				const additions = newImages.map((img, idx) => ({
			...
			const processImageFiles = (files) => {
				...
				for (let i = 0; i < files.length; i++) {
					const file = files[i];
					if (file && file.type.startsWith("image/")) readPromises.push(new Promise((resolve) => {
				...
				if (readPromises.length > 0) Promise.all(readPromises).then((newImgs) => {
					addImages(newImgs);
				});
			};
			const handlePaste = (e) => {
				...
				if (items !== void 0 && items.length > 0) {
					...
					for (let i = 0; i < items.length; i++) {
						const item = items[i];
						if (item !== void 0 && item.type.startsWith("image/")) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("textarea", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									...
									children: "↑↓ 选择 · Enter / Tab 确认 · Esc 关闭"
								})]
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								children: filteredItems.map((item, idx) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											...
											"data-kind": item.kind,
											children: item.kind === "command" ? "⚡ 命令" : "🧩 技能"
										}),
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
					...
					images.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "dsh-atb-img-rail",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: "dsh-atb-img-rail-label",
							children: [
								"已添加图片 (",
								images.length,
								")"
							...
							className: "dsh-atb-img-list",
							children: images.map((img) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								className: "dsh-atb-img-card",
								children: [
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								...
								children: [
									...
									" 补全命令与技能 · 截图直接 ",
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("code", { children: "Ctrl+V" }),
									" 粘贴图片 · 支持拖拽"
								]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
		...
		const PERMISSION_OPTIONS = [
			{
				...
				label: "可写入工作区",
				hint: "可读写工作区及临时目录（推荐默认）",
				icon: "📁"
			},
			{
				value: "read-only",
				label: "仅可查看",
				hint: "只读查看与检索，禁止修改文件或执行外部命令",
				icon: "🔒"
			},
			{
				value: "danger-full-access",
				label: "完全权限",
				hint: "完全无限制权限，可访问全盘及执行外部命令",
				icon: "⚡"
			}
		];
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Field, {
									...
									children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
										...
										children: PERMISSION_OPTIONS.map((opt) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
											type: "button",
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
									className: "dsh-atb-diag-sec",
									children: [
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h4", { children: "默认执行权限" }),
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											className: "dsh-atb-perm-picker",
											children: [
												/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
													...
													children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
														className: "dsh-atb-perm-name",
														children: "📁 可写入工作区（出厂默认）"
													}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
														className: "dsh-atb-perm-hint",
														children: "可读写工作区及临时目录，写操作无需二次确认"
													})]
												}),
												/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
													type: "button",
													...
													children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
														...
														className: "dsh-atb-perm-hint",
														children: "仅允许只读查看与检索，禁止修改文件或破坏性命令"
													})]
												}),
												/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
													type: "button",
													...
													children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
														...
														className: "dsh-atb-perm-hint",
														children: "完全无限制权限，可访问全盘及执行系统外部命令"
													})]
												})
											]
										}),
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
											...
											children: [
												"当前保存的默认：",
												currentPerm === "read-only" ? "🔒 仅可查看" : currentPerm === "danger-full-access" ? "⚡ 完全权限" : "📁 可写入工作区",
												"。 新建任务时预设的执行权限。"
											]
										})
									]
								...
								children: state.templates.map((t) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
											...
											title: `${t.builtin === true ? "内置" : "自建"}${t.task.checklist !== void 0 && t.task.checklist.length > 0 ? ` · 清单 ${t.task.checklist.length} 项` : ""}${t.task.urgency !== void 0 ? ` · ${t.task.urgency}` : ""}${t.task.permission !== void 0 ? ` · 权限: ${t.task.permission}` : ""}`,
											children: [
												...
												t.task.permission !== void 0 && t.task.permission !== "workspace-write" ? ` · ${t.task.permission === "read-only" ? "仅查看" : "全权限"}` : ""
											]
										}),
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
