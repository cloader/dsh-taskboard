...
function validateImportedTask(raw, now) {
	...
	try {
		const execution = normalizeExecution(typeof e.execution === "object" && e.execution !== null ? e.execution : {}, now, { allowPastRunAt: true });
		const comments = [];
