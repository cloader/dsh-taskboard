...
export const zh = {
  ...
  'detail.chip.queuedRun': '等待执行 · 原定 {time}',
  ...
  'form.field.periodicCompletion': '定期任务完成后',
  'form.periodicCompletion.rearm': '完成后移回待办',
  'form.periodicCompletion.rearmHint': '宿主自动复位本卡，下一次 cron 继续执行',
  'form.periodicCompletion.spawn': '完成后新建待办（默认）',
  'form.periodicCompletion.spawnHint': '本轮保留待验收，宿主新建下一轮待办卡',
  ...
  'set.aria': '看板设置',
  'set.title': '看板设置',
  'set.subtitle': '新建任务、调度、会话同步与本地数据存储',
  ...
  'set.schedule.heading': '定时调度',
  'set.schedule.hint': '立即生效于后续调度和执行。离线错过窗口只用于主机未运行时的历史触发；排队保质期为 0 时，已入队任务会跨重启保留。',
  'set.schedule.concurrent': '最大并发执行数（1–100）',
  'set.schedule.missedAfter': '离线错过超时后不补任务（分钟，1–1440）',
  'board.queue.chip': '排队{n}',
  'queue.panel.title': '执行队列',
  'queue.depth': '排队数',
  'queue.wait': '最久等待',
  'queue.clear': '清空队列',
