...
export const en: TaskboardDict = {
  ...
  'set.schedule.hint': 'Takes effect for subsequent scheduler and execution checks. Queued work is never subject to this window; it only classifies historical windows missed while the host was offline.',
